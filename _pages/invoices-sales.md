...
<style>
  ...
  .sales-table th.sortable::after {
    content: ' ⇅';
    opacity: 0.5;
  }

  .sales-table th.sort-asc::after {
    content: ' ↑';
    opacity: 1;
  }

  .sales-table th.sort-desc::after {
    content: ' ↓';
    opacity: 1;
  }
...
<div class="sales-header">
  <h1>Sale Records</h1>
  <p>All sale transactions for the LEGO collection</p>
</div>

<div class="sales-links">
  <a href="https://docs.google.com/spreadsheets/d/e/2PACX-1vQapC28lOT4SDmPSVl5IYDdexOhOb-bM98lVGYD2ruPF7c3TFkbxGDSUuktZHbYESyAitNNLDzNrghY/pubhtml" target="_blank" rel="noopener">View Full Spreadsheet</a>
</div>
...
<div class="sales-table-container">
  <div id="sales-table">
    <div class="loading-message">Loading sale data...</div>
  </div>
</div>

<div class="table-info" id="table-info"></div>

<script src="{{ site.baseurl }}/assets/js/sales-loader.js"></script>
